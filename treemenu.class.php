	...
	*/
    public function DisplayNode($id,$last)
    {
        ...
        if($node->getNumChildren()>0)
        {
        	...
        	if($last)
        	   echo "<img src='".$httproot."includes/styles/".$this->style."/images/".$symbol."-last.jpg' class='image-last' onclick='Switch(this,\"".$this->style."\",\"".$httproot."\")'></img>";
        	   ...
        	   echo "<img src='".$httproot."includes/styles/".$this->style."/images/".$symbol.".jpg' class='image' onclick='Switch(this,\"".$this->style."\",\"".$httproot."\")'></img>";
