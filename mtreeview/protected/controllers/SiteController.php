...
class SiteController extends Controller
{
	...
	public function actionAdjacency(){
		$this->render('adjacency');
	}
	public function actionnestedSet(){
		$this->render('nestedSet');
	}
	
	public function actionajaxTree(){
		$this->render('ajaxTree');
	}
	...
	public function actionajaxFillTree2(){
		Yii::import('application.extensions.MTreeView.MTreeView');
	    if (!Yii::app()->request->isAjaxRequest) {
		    exit();
	    }
	...
	public function actionajaxFillTree3(){
		Yii::import('application.extensions.MTreeView.MTreeView');
	    if (!Yii::app()->request->isAjaxRequest) {
		    exit();
	    }
	    ...
	    MTreeView::$_template_ =  "{icon}Text:{text}";
