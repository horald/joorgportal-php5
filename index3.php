...
function startmenu_mobil() {
  echo "<table><tr><td valign='top'>";
  echo "<legend>Navigation</legend>";
  page_menu($treeMenu,'0','mobil','');
  $winwidth=1035;
  $winheight=580;
  echo "</td><td valign='top'>";
  echo "            <iframe name='MyFensterlein' width='".$winwidth."' height='".$winheight."'";
...
//    echo "    <link rel='stylesheet' type='text/css' href='includes/styles/menunav.css'>";
    echo "    </head>";
    echo "    <body>";
    ...
    echo "    <script type='text/javascript' src='includes/js/menunav.js'></script>";
}
