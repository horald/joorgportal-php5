...
function aufeinkaufsliste($pararray,$idwert,$rezeptid) {
  echo "<h4>Auf die Einkaufsliste</h4><br>";
  include("../config.php");
  $query="SELECT * FROM ".$pararray['dbtable']." WHERE fldid_rezepte=".$rezeptid;
  //echo $query."=query<br>";  
...
function pruefvorrat($pararray,$idrezept) {
